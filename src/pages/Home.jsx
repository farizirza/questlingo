  ...
  return (
    <div className="min-h-[100dvh] bg-background flex items-center justify-center p-4 sm:p-8 font-sans relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-[10%] -left-[10%] w-[40vw] h-[40vw] rounded-full opacity-[0.15]"
          style={{ background: 'radial-gradient(circle, var(--primary) 0%, transparent 70%)' }}
        />
        <div
          className="absolute bottom-[10%] -right-[10%] w-[40vw] h-[40vw] rounded-full opacity-[0.15]"
